...
End Sub
Sub 雪莉_自殺傾向(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(1).Caption = "自殺傾向" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(1, 2) = 1) _
 ...
 Select Case stagenum
    Case 1
        ...
        End If
    Case 45
        atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & atkingpagetot(1, 4) * 5 & "="
    Case 3
        For i = 人物技能數字指示 To 1 Step -1
             If atkingno(i, 1) = "" Then
...
End If
End Sub
Sub 雪莉_VBE_自殺傾向(ByVal stagenum As Integer)
Dim bloodnum As Integer, i As Integer '暫時變數
If FormMainMode.personatk(1).Caption = "VBE自殺傾向" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(42, 2) = 1) _
 ...
 Select Case stagenum
    Case 1
        ...
        End If
    Case 45
        atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & atkingpagetot(1, 4) * 10 & "="
    Case 3
        For i = 人物技能數字指示 To 1 Step -1
             If atkingno(i, 1) = "" Then
                atkingno(i, 1) = app_path & "gif\雪莉\雪莉_自殺傾向_1.jpg"
...
If FormMainMode.personatk(2).Caption = "VBE異質者" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(43, 2) = 1) _
   And FormMainMode.uspi1(角色人物對戰人數(1, 2)) = "雪莉" Then
    Select Case atkingck(43, 1)
     ...
     Case 3
'          atkingck(43, 2) = 0
          If Val(擲骰表單溝通暫時變數(2)) >= liveus(角色人物對戰人數(1, 2)) And 異常狀態檢查數(14, 2) = 0 Then
                atkingck(43, 2) = 0
                Do
...
End Sub
Sub 雪莉_VBE_飛刃雨(ByVal stagenum As Integer)
Dim ttt As Integer, i As Integer '暫時變數
   ...
   And FormMainMode.uspi1(角色人物對戰人數(1, 2)) = "雪莉" Then
    Select Case stagenum
         Case 1
            ...
            End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & pageqlead(1) * movecp * 2 & "="
        Case 3
            For i = 人物技能數字指示 To 1 Step -1
              If atkingno(i, 1) = "" Then
...
Sub 雪莉_飛刃雨(ByVal stagenum As Integer)
Dim ttt As Integer, i As Integer '暫時變數
   ...
   And FormMainMode.uspi1(角色人物對戰人數(1, 2)) = "雪莉" Then
    Select Case stagenum
         Case 1
            ...
            End If
         Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & pageqlead(1) * 2 & "="
         Case 3
            For i = 人物技能數字指示 To 1 Step -1
              If atkingno(i, 1) = "" Then
                 atkingno(i, 1) = app_path & "gif\雪莉\雪莉_飛刃雨_1.jpg"
...
End If
End Sub
Sub 古魯瓦爾多_血之恩賜(ByVal stagenum As Integer)
Dim bloodtot As Integer, i As Integer '暫時變數
If FormMainMode.personatk(3).Caption = "血之恩賜" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(60, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
            ...
            End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 6 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 3
             戰鬥系統類.自動捲軸捲動
             For i = 人物技能數字指示 To 1 Step -1
...
Sub 古魯瓦爾多_猛擊(ByVal stagenum As Integer)
Dim rrr As Integer, i As Integer '暫時變數
   ...
   Select Case stagenum
        Case 1
            ...
            If rrr < 2 And atkingck(6, 2) = 1 Then
             ...
             End If
        Case 45
            atkingckdice(1, 2, 1) = atkingckdice(1, 2, 1) & "+" & 6 & "="
        Case 2
            戰鬥系統類.人物技能欄燈開關 False, 1
            atkingck(6, 2) = 0
            戰鬥系統類.自動捲軸捲動
...
End Sub
Sub 古魯瓦爾多_精神力吸收()
Dim rrr(1 To 3) As Integer, i As Integer '牌判斷暫時變數
...
End Sub
Sub 艾茵_一顆心()
Dim cardnum(1 To 2) As Integer, i As Integer '暫時變數
...
Sub 艾茵_九個靈魂(ByVal stagenum As Integer)
Dim bloodtot As Single  '暫時變數
...
If FormMainMode.personatk(3).Caption = "九個靈魂" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(26, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
          ...
          End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 9 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 3
             戰鬥系統類.自動捲軸捲動
             For i = 人物技能數字指示 To 1 Step -1
...
End If
End Sub
Sub 艾茵_十三隻眼(ByVal stagenum As Integer)
Dim rrr(1 To 2) As Integer, i As Integer '暫時變數
   ...
   Select Case stagenum
        Case 1
          ...
          If (rrr(1) < 1 Or rrr(2) < 1) And atkingck(16, 2) = 1 Then
           ...
           End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "@" & 13 & "="
            atkingckdice(1, 2, 1) = atkingckdice(1, 2, 1) & "@" & 0 & "="
        Case 4
             戰鬥系統類.人物技能欄燈開關 False, 4
             戰鬥系統類.自動捲軸捲動
             atkingck(16, 2) = 0
...
End If
End Sub
Sub 蕾_輪旋曲_琉璃色的微風(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(1).Caption = "輪旋曲-琉璃色的微風" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(13, 2) = 1) _
   ...
   Select Case stagenum
        ...
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 6 & "="
            atkingckdice(1, 2, 1) = atkingckdice(1, 2, 1) & "-" & 3 & "="
        Case 3
             戰鬥系統類.人物技能欄燈開關 False, 1
             atkingck(13, 2) = 0
             戰鬥系統類.自動捲軸捲動
...
End If
End Sub
Sub 蕾_EX_輪旋曲_琉璃色的微風(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(1).Caption = "Ex輪旋曲-琉璃色的微風" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(19, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
          ...
          End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 8 & "="
            atkingckdice(1, 2, 1) = atkingckdice(1, 2, 1) & "-" & 6 & "="
        Case 3
             戰鬥系統類.人物技能欄燈開關 False, 1
             atkingck(19, 2) = 0
          ...
          Do
            ...
            For j = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
                 ...
                 If 人物異常狀態資料庫(1, j, 3) = 8 And 人物異常狀態資料庫(1, j, 2) > 0 Then
                     ...
                     人物異常狀態資料庫(1, j, 2) = 3
                     '========DEF+1立即生效
                        戰鬥系統類.直接寫入顯示列數值 1, 攻擊防禦骰子總數(1) + 1
                    '===============
                     Exit Do
                 End If
            Next
           For j = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
              If 人物異常狀態資料庫(1, j, 2) = 0 Then
                 ...
                 異常狀態檢查數(8, 2) = 1
                  '========DEF+3立即生效
                    戰鬥系統類.直接寫入顯示列數值 1, 攻擊防禦骰子總數(1) + 3
                  '===============
                 Exit Do
             End If
           Next
...
Sub 蕾_安魂曲_死神的鎮魂歌()
Dim rrr As Integer, i As Integer, j As Integer '暫時變數
...
End If
End Sub
Sub 蕾_終曲_無盡輪迴的終結(ByVal stagenum As Integer)
...
If FormMainMode.personatk(4).Caption = "終曲-無盡輪迴的終結" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(15, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
          ...
          End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 16 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 4
             戰鬥系統類.自動捲軸捲動
             For i = 人物技能數字指示 To 1 Step -1
...
End If
End Sub
Sub 蕾_EX_終曲_無盡輪迴的終結(ByVal stagenum As Integer)
Dim num(1 To 2) As Integer, i As Integer '選擇人物暫時變數
If FormMainMode.personatk(4).Caption = "Ex終曲-無盡輪迴的終結" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(161, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
            ...
            End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 18 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 4
             戰鬥系統類.自動捲軸捲動
...
Dim cardpn As Integer, i As Integer '紀錄牌總數暫時變數
...
If FormMainMode.personatk(2).Caption = "慟哭之歌" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(57, 2) = 1) _
   ...
   Select Case atkingck(57, 1)
        ...
        Case 2
             ...
             Next
             '===============
             戰鬥系統類.直接寫入顯示列數值 2, 攻擊防禦骰子總數(2) \ 2
        Case 3
            atkingck(57, 2) = 0
            Do
               For i = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
...
End If
End Sub
Sub 伊芙琳_紅蓮車輪(ByVal stagenum As Integer)
Dim bloodtot As Integer, i As Integer '暫時變數
...
End Sub
Sub 伊芙琳_赤紅石榴()
Dim mkp As Integer, i As Integer '暫時變數
Dim cardp(1 To 106) As Boolean '紀錄暫時變數
...
End If
End Sub
Sub CC_白銀戰機(ByVal stagenum As Integer)
Dim bloodntot As Integer, i As Integer '暫時變數
If FormMainMode.personatk(2).Caption = "白銀戰機" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(34, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
          ...
          End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 4 & "="
        Case 2
            atkingtrn(1) = Val(atkingtrn(1)) + 1
        Case 3
             戰鬥系統類.人物技能欄燈開關 False, 2
...
End If
End Sub
Sub CC_原子之心(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(3).Caption = "原子之心" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(36, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
            ...
            End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 2 & "="
        Case 2
            '===========將所有技能無效化-電腦方(階段1)
            atkingtrn(2) = 0
...
End If
End Sub
Sub CC_高頻電磁手術刀(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(4).Caption = "高頻電磁手術刀" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(35, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
            ...
            End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 24 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 4
             atkingck(35, 1) = 3
             戰鬥系統類.自動捲軸捲動
         ...
         If atkingck(17, 2) = 1 Then
             For i = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
                 If 人物異常狀態資料庫(1, i, 3) = 13 And 人物異常狀態資料庫(1, i, 2) >= 1 Then
                     FormDice.技能_帕茉_靜謐之背_分支_階段三 (人物異常狀態資料庫(1, i, 2))
                     atkingck(17, 1) = 4
                     Exit For
                 End If
             Next
...
End If
End Sub
Sub 帕茉_慈悲的藍眼(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(3).Caption = "慈悲的藍眼" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(9, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
            ...
            End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "@" & 0 & "="
        Case 4
            戰鬥系統類.人物技能欄燈開關 False, 3
            戰鬥系統類.自動捲軸捲動
            For i = 人物技能數字指示 To 1 Step -1
...
If FormMainMode.personatk(1).Caption = "殺戮器官" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(21, 2) = 1) _
   ...
   Select Case atkingck(21, 1)
        ...
        Case 3
            ...
            戰鬥系統類.擲骰表單人物立繪紀錄數(1) = app_path & "gif\史塔夏\殺戮\Staciaperson1.png"
...
End If
End Sub
Sub 史塔夏_愚者之手(ByVal stagenum As Integer)
Dim apn As Integer, i As Integer
   ...
   Select Case stagenum
        ...
        Case 45
            For i = 1 To 3
                 ...
                 End If
             Next
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & apn * 4 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 2
             戰鬥系統類.自動捲軸捲動
             For i = 人物技能數字指示 To 1 Step -1
...
End If
End Sub
Sub 羅莎琳_黑霧幻影(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(1).Caption = "黑霧幻影" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(54, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
          ...
          End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 5 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 1
             戰鬥系統類.自動捲軸捲動
             For i = 人物技能數字指示 To 1 Step -1
...
End If
End Sub
Sub 羅莎琳_EX_黑霧幻影(ByVal stagenum As Integer)
Dim i As Integer
...
Sub 羅莎琳_染血之刃(ByVal stagenum As Integer)
Dim i As Integer
   ...
   Select Case atkingck(53, 1)
        ...
        Case 2
             ...
             If atkingpagetot(2, 4) >= 1 Then
                 戰鬥系統類.直接寫入顯示列數值 2, Int(攻擊防禦骰子總數(2) / 3 + 0.9)
             Else
                 戰鬥系統類.直接寫入顯示列數值 2, Int(攻擊防禦骰子總數(2) / 2 + 0.9)
             End If
   End Select
End If
End Sub
Sub 羅莎琳_黑霧的纏繞(ByVal stagenum As Integer)
Dim m As Integer, i As Integer '暫時變數
...
End If
End Sub
Sub 梅倫_High_hand(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(1).Caption = "High hand" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(63, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
            ...
            End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & pageqlead(2) * 2 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 1
             戰鬥系統類.自動捲軸捲動
             atkingck(63, 2) = 0
...
If FormMainMode.personatk(1).Caption = "美味牛奶" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(67, 2) = 1) _
   ...
   Select Case atkingck(67, 1)
        ...
        Case 3
            ...
            戰鬥系統類.擲骰表單人物立繪紀錄數(1) = app_path & "gif\音音夢\成長\Nenemperson1.png"
...
End If
End Sub
Sub 音音夢_溫柔注射(ByVal stagenum As Integer)
Dim n(1 To 2) As Integer, i As Integer
...
End If
End Sub
Sub 音音夢_愉快抽血(ByVal stagenum As Integer)
Dim n(1 To 2) As Integer, i As Integer
 ...
 Select Case stagenum
    Case 1
        If atkingck(69, 2) = 0 And atkingpagetot(1, 4) > 0 Then
           ...
           atkingck(69, 2) = 1
           atkingtrn(1) = Val(atkingtrn(1)) + 1
        ElseIf atkingck(69, 2) = 1 And atkingpagetot(1, 4) = 0 Then
           戰鬥系統類.人物技能欄燈開關 False, 3
           atkingck(69, 2) = 0
           atkingtrn(1) = Val(atkingtrn(1)) - 1
        End If
...
End If
End Sub
Sub 艾伯李斯特_精密射擊(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 艾伯李斯特_雷擊(ByVal stagenum As Integer)
...
End If
End Sub
Sub 艾伯李斯特_茨林(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(3).Caption = "茨林" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(73, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
          ...
          End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 7 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 3
             戰鬥系統類.自動捲軸捲動
             For i = 人物技能數字指示 To 1 Step -1
...
End If
End Sub
Sub 艾依查庫_連射(ByVal stagenum As Integer)
...
End If
End Sub
Sub 艾依查庫_神速之劍(ByVal stagenum As Integer)
...
If FormMainMode.personatk(2).Caption = "神速之劍" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(79, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
            ...
            End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & Int(atkingpagetot(1, 1) / 2 + 0.5) & "="
        Case 4
             戰鬥系統類.人物技能欄燈開關 False, 2
             atkingck(79, 2) = 0
             戰鬥系統類.自動捲軸捲動
...
End If
End Sub
Sub 艾依查庫_憤怒一擊(ByVal stagenum As Integer)
...
If FormMainMode.personatk(3).Caption = "憤怒一擊" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(80, 2) = 1) _
   ...
   Select Case stagenum
        ...
        Case 45
            ...
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & ape & "="
        Case 2
            戰鬥系統類.人物技能欄燈開關 False, 3
            atkingck(80, 2) = 0
            戰鬥系統類.自動捲軸捲動
...
If FormMainMode.personatk(2).Caption = "時間追獵" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(83, 2) = 1) _
   ...
   Select Case atkingck(83, 1)
        ...
        Case 2
             ...
             '=====================
            atkingck(83, 2) = 0
            戰鬥系統類.直接寫入顯示列數值 2, 攻擊防禦骰子總數(2) - Val(FormMainMode.turni)
   End Select
End If
End Sub
Sub 布勞_時間爆彈(ByVal stagenum As Integer)
Dim tn As Integer, i As Integer
...
End If
End Sub
Sub 阿貝爾_霸王閃擊(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 阿貝爾_閃電旋風刺(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 阿貝爾_幻影劍舞(ByVal stagenum As Integer)
Dim rrr(1 To 3) As Integer, i As Integer '暫時變數
...
End If
End Sub
Sub 利恩_毒牙(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 利恩_背刺(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(4).Caption = "背刺" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(93, 2) = 1) _
   ...
   Select Case stagenum
      Case 1
            ...
            End If
      Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 12 & "="
      Case 2
             戰鬥系統類.人物技能欄燈開關 False, 4
             戰鬥系統類.自動捲軸捲動
             For i = 人物技能數字指示 To 1 Step -1
             ...
             If 執行動作_檢查是否有指定異常狀態(2, 17) = False Then
                直接寫入顯示列數值 1, 攻擊防禦骰子總數(1) - 12
             End If
   End Select
End If
End Sub
Sub 夏洛特_冬之夢(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 泰瑞爾_Rud_913(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 泰瑞爾_Von_541(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 泰瑞爾_Chr_799(ByVal stagenum As Integer)
...
End If
End Sub
Sub 瑪格莉特_月光(ByVal stagenum As Integer)
Dim m As Integer, i As Integer
If FormMainMode.personatk(1).Caption = "月光" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(122, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
          ...
          End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 3 & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 1
             戰鬥系統類.自動捲軸捲動
             For i = 人物技能數字指示 To 1 Step -1
...
End If
End Sub
Sub 瑪格莉特_恍惚(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 庫勒尼西_沙漠中的海市蜃樓(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(1).Caption = "沙漠中的海市蜃樓" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(128, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
            If movecp = 3 And atkingck(128, 2) = 0 Then
                atkingck(128, 2) = 1
                戰鬥系統類.人物技能欄燈開關 True, 1
                atkingtrn(1) = Val(atkingtrn(1)) + 1
            ElseIf movecp <> 3 And atkingck(128, 2) = 1 Then
                atkingck(128, 2) = 0
                戰鬥系統類.人物技能欄燈開關 False, 1
                atkingtrn(1) = Val(atkingtrn(1)) - 1
            End If
...
End If
End Sub
Sub 庫勒尼西_瘋狂眼窩(ByVal stagenum As Integer)
Dim i As Integer, m As Integer
...
End If
End Sub
Sub 庫勒尼西_黑暗漩渦(ByVal stagenum As Integer)
Dim m As Integer, i As Integer
...
End If
End Sub
Sub 蕾格烈芙_CTL(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 蕾格烈芙_BPA(ByVal stagenum As Integer)
Dim i As Integer
...
End Sub
Sub 蕾格烈芙_SSS()
Dim rrr(1 To 3) As Integer, i As Integer, j As Integer '暫時變數
...
End If
End Sub
Sub 多妮妲_律死擊(ByVal stagenum As Integer)
Dim i As Integer, j As Integer
...
End If
End Sub
Sub 傑多_因果之幻(ByVal stagenum As Integer)
Dim p, i, j As Integer
...
End If
End Sub
Sub 阿奇波爾多_致命槍擊(ByVal stagenum As Integer)
Dim rrr(1 To 3) As Integer, i As Integer '暫時變數
...
End If
End Sub
Sub 阿奇波爾多_防護射擊(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(4).Caption = "防護射擊" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(152, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
           If movecp > 1 Then
                If atkingpagetot(1, 5) >= 1 And atkingck(152, 2) = 0 Then
                    atkingck(152, 2) = 1
                    戰鬥系統類.人物技能欄燈開關 True, 4
                    atkingtrn(1) = Val(atkingtrn(1)) + 1
                End If
          ...
          End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & (atkingpagetot(1, 5) + 2) & "="
        Case 2
             戰鬥系統類.人物技能欄燈開關 False, 4
             戰鬥系統類.自動捲軸捲動
             atkingck(152, 2) = 0
...
End If
End Sub
Sub 洛洛妮_風暴感知(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 洛洛妮_砲擊壓制(ByVal stagenum As Integer)
Dim i As Integer, j As Integer
...
End If
End Sub
Sub 洛洛妮_貪婪之刃與嗜血之槍(ByVal stagenum As Integer)
Dim i As Integer, k As Integer
...
End If
End Sub
Sub 克頓_隱蔽射擊(ByVal stagenum As Integer)
Dim p, i, j As Integer
...
End If
End Sub
Sub 露緹亞_腐朽之靈(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 露緹亞_朦朧之暗(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 露緹亞_暗影之翼(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 露緹亞_渦騎劍閃(ByVal stagenum As Integer)
Dim aw As Integer, i As Integer
   ...
   Select Case stagenum
        Case 1
             If movecp = 3 Then
                If atkingpagetot(1, 1) >= 1 And atkingpagetot(1, 5) >= 4 And atkingpagetot(1, 4) >= 1 And atkingck(101, 2) = 0 Then
                     ...
                     atkingtrn(1) = Val(atkingtrn(1)) + 1
                End If
                If (atkingpagetot(1, 1) < 1 Or atkingpagetot(1, 5) < 4 Or atkingpagetot(1, 4) < 1) And atkingck(101, 2) = 1 Then
                    戰鬥系統類.人物技能欄燈開關 False, 4
                    atkingck(101, 2) = 0
                    atkingtrn(1) = Val(atkingtrn(1)) - 1
                End If
        ...
        Case 45
            For i = 1 To 106
               ...
               End If
            Next
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & aw * 5 + 8 & "="
        Case 4
             戰鬥系統類.人物技能欄燈開關 False, 4
             atkingck(101, 2) = 0
             戰鬥系統類.自動捲軸捲動
...
End If
End Sub
Sub 艾蕾可_王座之炎(ByVal stagenum As Integer)
   ...
   Select Case stagenum
        Case 1
             If atkingpagetot(1, 1) >= 5 And atkingck(102, 2) = 0 Then
               ...
               atkingck(102, 2) = 1
               atkingtrn(1) = Val(atkingtrn(1)) + 1
            ElseIf atkingpagetot(1, 1) < 5 And atkingck(102, 2) = 1 Then
               戰鬥系統類.人物技能欄燈開關 False, 1
               atkingck(102, 2) = 0
               atkingtrn(1) = Val(atkingtrn(1)) - 1
            End If
        Case 45
            atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & pageqlead(1) * 3 & "="
        Case 3
             戰鬥系統類.人物技能欄燈開關 False, 1
             戰鬥系統類.自動捲軸捲動
             For i = 人物技能數字指示 To 1 Step -1
...
If FormMainMode.personatk(3).Caption = "聖王威光" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(104, 2) = 1) _
   ...
   Select Case atkingck(104, 1)
        ...
        Case 2
             ...
             Next
        Case 3
             atking_艾蕾可_聖王威光紀錄數(1) = 攻擊防禦骰子總數(2)
...
End If
End Sub
Sub 梅莉_夢幻魔杖(ByVal stagenum As Integer)
...
End If
End Sub
Sub 梅莉_徬徨夢羽(ByVal stagenum As Integer)
...
End If
End Sub
Sub 梅莉_夢境搖籃(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 貝琳達_水晶幻鏡(ByVal stagenum As Integer)
Dim i As Integer
...
End If
End Sub
Sub 貝琳達_裂地冰牙(ByVal stagenum As Integer)
Dim wtr As Integer, wert(1 To 3) As Boolean, wery As Integer, i As Integer '暫時變數
...
End If
End Sub
Sub 貝琳達_溶魂之雨(ByVal stagenum As Integer)
Dim i As Integer
If FormMainMode.personatk(4).Caption = "溶魂之雨" And (執行動作_檢查是否有指定異常狀態(1, 22) = False Or atkingck(113, 2) = 1) _
   ...
   Select Case stagenum
        Case 1
            ...
            End If
        Case 45
            If pageqlead(1) >= 15 Then
                atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 35 & "="
            ElseIf pageqlead(1) >= 10 Then
                atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 20 & "="
            Else
                atkingckdice(1, 1, 1) = atkingckdice(1, 1, 1) & "+" & 10 & "="
            End If
        Case 2
            戰鬥系統類.人物技能欄燈開關 False, 4
            戰鬥系統類.自動捲軸捲動
...
End If
End Sub
Sub 尤莉卡_奸佞的鐵鎚(ByVal stagenum As Integer)
Dim wert As Integer, i As Integer '暫時變數
...
End If
End Sub
Sub 尤莉卡_不善的信仰(ByVal stagenum As Integer)
Dim wert As Integer, i As Integer '暫時變數
...
End If
End Sub
Sub 尤莉卡_曲惡的安寧(ByVal stagenum As Integer)
Dim wert As Integer, i As Integer, k As Integer '暫時變數
...
End If
End Sub
Sub 尤莉卡_超載(ByVal stagenum As Integer)
Dim wert As Integer, i As Integer '暫時變數
...
End If
End Sub
Sub 羅莎琳_EX_染血之刃(ByVal stagenum As Integer)
Dim i As Integer
