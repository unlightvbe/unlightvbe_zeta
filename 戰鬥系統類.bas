...
Public EventPersonAbilityDiceChangeNum(1 To 2, 1 To 2) As Integer '骰量更新顯示-角色能力對骰數變化量控制暫時變數(1.使用者方/2.電腦方,1.變化量/2.是否為指定)
Public 擲骰表單人物立繪紀錄數(1 To 2) As String 'FormDice人物立繪圖片路徑紀錄(1.使用者方/2.電腦方)
...
Select Case stagenum
    ...
    Case 3
            ...
            戰鬥系統類.擲骰表單人物立繪紀錄數(1) = app_path & "gif\史塔夏\一般\Staciaperson1.png"
...
End Select
End Sub
Sub 特殊_史塔夏_殺戮狀態_電腦(ByVal stagenum As Integer)
Select Case stagenum
    Case 1
    ...
    Case 3
            ...
            戰鬥系統類.擲骰表單人物立繪紀錄數(2) = app_path & "gif\史塔夏\一般\Staciaperson2.png"
...
Select Case stagenum
    ...
    Case 3
            ...
            戰鬥系統類.擲骰表單人物立繪紀錄數(1) = app_path & "gif\音音夢\一般\Nenemperson1.png"
...
End Select
End Sub
Sub 特殊_音音夢_成長狀態_電腦(ByVal stagenum As Integer)
Select Case stagenum
    Case 1
    ...
    Case 3
            ...
            戰鬥系統類.擲骰表單人物立繪紀錄數(2) = app_path & "gif\音音夢\一般\Nenemperson2.png"
...
Select Case m
    Case 1
       戰鬥系統類.擲骰表單人物立繪紀錄數(1) = app_path & "gif\布勞\Blauperson1-1.png"
    Case 2
       戰鬥系統類.擲骰表單人物立繪紀錄數(1) = app_path & "gif\布勞\Blauperson1-2.png"
    Case 3
       戰鬥系統類.擲骰表單人物立繪紀錄數(1) = app_path & "gif\布勞\Blauperson1-3.png"
End Select
End Sub
Sub 特殊_布勞_一般立繪更換_電腦()
Dim m As Integer
...
Select Case m
    Case 1
       戰鬥系統類.擲骰表單人物立繪紀錄數(2) = app_path & "gif\布勞\Blauperson2-1.png"
    Case 2
       戰鬥系統類.擲骰表單人物立繪紀錄數(2) = app_path & "gif\布勞\Blauperson2-2.png"
    Case 3
       戰鬥系統類.擲骰表單人物立繪紀錄數(2) = app_path & "gif\布勞\Blauperson2-3.png"
End Select
End Sub
...
End Sub
Sub 異常狀態骰數增加檢查_DEF(ByVal uscom As Integer)
Select Case uscom
 Case 1
    '=========以下是技能檢查及發動
    異常狀態檢查數(8, 1) = 1
...
Select Case turnatk
 Case 1
    ...
    If atkingck(49, 2) = 1 Then 技能.尤莉卡_超載 45
    '==================================
    ...
    If atkingckai(139, 2) = 1 Then AI技能.尤莉卡_超載 45
    If atkingckai(44, 2) = 1 Then AI技能.庫勒尼西_沙漠中的海市蜃樓 45
    '==================================
    戰鬥系統類.異常狀態骰數增加檢查_ATK 1
    戰鬥系統類.異常狀態骰數增加檢查_DEF 2
    '==================================
    If FormMainMode.uspi1(角色人物對戰人數(1, 2)).Caption = "史塔夏" And atking_史塔夏_殺戮模式狀態數(2) = 1 Then 戰鬥系統類.特殊_史塔夏_殺戮狀態_使用者 1 '(階段1)
    If FormMainMode.uspi1(角色人物對戰人數(1, 2)).Caption = "音音夢" And atking_音音夢_成長模式狀態數(2) = 1 Then 戰鬥系統類.特殊_音音夢_成長狀態_使用者 1 '(階段1)
 Case 2
    ...
    If atkingck(49, 2) = 1 Then 技能.尤莉卡_超載 45
    If atkingck(128, 2) = 1 Then 技能.庫勒尼西_沙漠中的海市蜃樓 45
    '==============================
    ...
    '==================================
    If FormMainMode.compi1(角色人物對戰人數(2, 2)).Caption = "史塔夏" And atking_AI_史塔夏_殺戮模式狀態數(2) = 1 Then 戰鬥系統類.特殊_史塔夏_殺戮狀態_電腦 1 '(階段1)
    If FormMainMode.compi1(角色人物對戰人數(2, 2)).Caption = "音音夢" And atking_AI_音音夢_成長模式狀態數(2) = 1 Then 戰鬥系統類.特殊_音音夢_成長狀態_電腦 1 '(階段1)
End Select
            ...
            If turnatk = 1 Then
                If atkingpagetot(1, 1) > 0 And movecp = 1 Then
                    If EventPersonAbilityDiceChangeNum(1, 2) = 0 Then
                        攻擊防禦骰子總數(1) = 攻擊防禦骰子總數(1) + atkus(角色人物對戰人數(1, 2))
                    End If
                    攻擊防禦骰子總數(1) = 攻擊防禦骰子總數(1) + EventPersonAbilityDiceChangeNum(1, 1)
            ...
            If turnatk = 2 Then
                If atkingpagetot(2, 1) > 0 And movecp = 1 Then
                    If EventPersonAbilityDiceChangeNum(2, 2) = 0 Then
                        攻擊防禦骰子總數(2) = 攻擊防禦骰子總數(2) + atkcom(角色人物對戰人數(2, 2))
                    End If
                    攻擊防禦骰子總數(2) = 攻擊防禦骰子總數(2) + EventPersonAbilityDiceChangeNum(2, 1)
...
End If
End Sub
Sub 解析角色能力對骰數變化(ByVal uscom As Integer, ByVal typestr As String, ByVal num As Integer)
Select Case typestr
    Case "+"
