...
If 移動圖片顯示數(1, 1) <= 移動圖片顯示數(1, 3) Then
   If 移動圖片顯示數(1, 2) = 1 Then
      moveleftjpg(移動圖片顯示數(1, 1)).Picture = LoadPicture(App.Path & "\gif\movein.gif")
      moveleftjpg(移動圖片顯示數(1, 1)).Visible = True
   Else
      moveleftjpg(移動圖片顯示數(1, 1)).Picture = LoadPicture(App.Path & "\gif\moveout.gif")
      moveleftjpg(移動圖片顯示數(1, 1)).Visible = True
   End If
...
If 移動圖片顯示數(2, 1) <= 移動圖片顯示數(2, 3) Then
   If 移動圖片顯示數(2, 2) = 1 Then
      moverightjpg(移動圖片顯示數(2, 1)).Picture = LoadPicture(App.Path & "\gif\moveout.gif")
      moverightjpg(移動圖片顯示數(2, 1)).Visible = True
   Else
      moverightjpg(移動圖片顯示數(2, 1)).Picture = LoadPicture(App.Path & "\gif\movein.gif")
      moverightjpg(移動圖片顯示數(2, 1)).Visible = True
   End If
