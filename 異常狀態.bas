   ...
   Case 1
     For i = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
       If 人物異常狀態資料庫(1, i, 3) = 7 Then
        atkingckdice(1, 1, 3) = atkingckdice(1, 1, 3) & "+" & 人物異常狀態資料庫(1, i, 1) & "="
       End If
     Next
   Case 2
     For i = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
   ...
   Case 1
     For i = 14 * (角色人物對戰人數(2, 2) - 1) + 1 To 14 * 角色人物對戰人數(2, 2)
       If 人物異常狀態資料庫(2, i, 3) = 1 Then
        atkingckdice(2, 2, 3) = atkingckdice(2, 2, 3) & "+" & 人物異常狀態資料庫(2, i, 1) & "="
       End If
     Next
   Case 2
     For i = 14 * (角色人物對戰人數(2, 2) - 1) + 1 To 14 * 角色人物對戰人數(2, 2)
  ...
  Case 1
     For i = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
       If 人物異常狀態資料庫(1, i, 3) = 24 Then
        atkingckdice(1, 1, 3) = atkingckdice(1, 1, 3) & "-" & 人物異常狀態資料庫(1, i, 2) * 1 & "="
        Exit For
       End If
     Next
End Select
  ...
  Case 1
     For i = 14 * (角色人物對戰人數(2, 2) - 1) + 1 To 14 * 角色人物對戰人數(2, 2)
       If 人物異常狀態資料庫(2, i, 3) = 25 Then
        atkingckdice(2, 2, 3) = atkingckdice(2, 2, 3) & "-" & 人物異常狀態資料庫(2, i, 2) * 1 & "="
        Exit For
       End If
     Next
End Select
...
Sub 臨界_電腦()
Dim i As Integer
Select Case 異常狀態檢查數(40, 1)
  Case 1
     For i = 14 * (角色人物對戰人數(2, 2) - 1) + 1 To 14 * 角色人物對戰人數(2, 2)
        If 人物異常狀態資料庫(2, i, 3) = 40 Then
             If 人物異常狀態資料庫(2, i, 2) < 3 Then
                atkingckdice(2, 2, 3) = atkingckdice(2, 2, 3) & "+" & 人物異常狀態資料庫(2, i, 2) * 1 & "="
                Exit For
             ElseIf 人物異常狀態資料庫(2, i, 2) >= 3 Then
