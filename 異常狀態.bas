   ...
   Case 1
     For i = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
       If 人物異常狀態資料庫(1, i, 3) = 7 Then
        戰鬥系統類.解析角色能力對骰數變化 1, "+", 人物異常狀態資料庫(1, i, 1)
       End If
     Next
   Case 2
     For i = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
   ...
   Case 1
     For i = 14 * (角色人物對戰人數(2, 2) - 1) + 1 To 14 * 角色人物對戰人數(2, 2)
       If 人物異常狀態資料庫(2, i, 3) = 1 Then
        戰鬥系統類.解析角色能力對骰數變化 2, "+", 人物異常狀態資料庫(2, i, 1)
       End If
     Next
   Case 2
     For i = 14 * (角色人物對戰人數(2, 2) - 1) + 1 To 14 * 角色人物對戰人數(2, 2)
  ...
  Case 1
     For i = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
       If 人物異常狀態資料庫(1, i, 3) = 24 Then
        戰鬥系統類.解析角色能力對骰數變化 1, "-", 人物異常狀態資料庫(1, i, 2)
        Exit For
       End If
     Next
End Select
  ...
  Case 1
     For i = 14 * (角色人物對戰人數(2, 2) - 1) + 1 To 14 * 角色人物對戰人數(2, 2)
       If 人物異常狀態資料庫(2, i, 3) = 25 Then
        戰鬥系統類.解析角色能力對骰數變化 2, "-", 人物異常狀態資料庫(2, i, 2)
        Exit For
       End If
     Next
End Select
