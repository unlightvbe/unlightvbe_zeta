                        ...
                        If movecpre < 3 Then
                               If cardAInumcaseperson(i, 1, 11) >= 3 And cardAInumcaseperson(i, 1, 15) >= 2 Then
                                   If cardAInumcaseperson(i, 1, 11) >= 6 And movecpre = 2 Then
                                       cardAInumFinal(i, 1) = 0 '==開靜謐之背時不應與慈悲的藍眼同開
                                   Else
                                        For k = 14 * (角色人物對戰人數(uscom, 2) - 1) + 1 To 14 * 角色人物對戰人數(uscom, 2)
                                              If 人物異常狀態資料庫(uscom, k, 3) = 26 And uscom = 2 Then
                                                  werp = 人物異常狀態資料庫(uscom, k, 2)
                                              ElseIf 人物異常狀態資料庫(uscom, k, 3) = 13 And uscom = 1 Then
                                                  werp = 人物異常狀態資料庫(uscom, k, 2)
                                              End If
                                        Next
                 ...
                 If Pn3 = 0 Then
                        ...
                        If movecpre < 3 Then
                               If cardAInumcaseperson(i, 1, 11) >= 2 And cardAInumcaseperson(i, 1, 15) >= 2 And cardAInumcaseperson(i, 1, 14) >= 1 Then
                                   For k = 14 * (角色人物對戰人數(uscom, 2) - 1) + 1 To 14 * 角色人物對戰人數(uscom, 2)
                                         If 人物異常狀態資料庫(uscom, k, 3) = 25 And uscom = 2 Then
                                             werp = 人物異常狀態資料庫(uscom, k, 2)
                                         ElseIf 人物異常狀態資料庫(uscom, k, 3) = 24 And uscom = 1 Then
                                             werp = 人物異常狀態資料庫(uscom, k, 2)
                                         End If
                                   Next
        ...
        For i = 1 To 2 ^ cardAInumuscom
             ...
             If Pn1 = 0 Then
                    ...
                    If movecpre > 1 Then
                           If cardAInumcaseperson(i, 1, 14) >= 2 Then
                               '=====如下2回合後屬質數回合才做總期望值加成
                               If Val(戰鬥系統類.turn) + 2 = 3 Or Val(戰鬥系統類.turn) + 2 = 5 Or Val(戰鬥系統類.turn) + 2 = 7 Or _
                                  Val(戰鬥系統類.turn) + 2 = 11 Or Val(戰鬥系統類.turn) + 2 = 13 Or Val(戰鬥系統類.turn) + 2 = 17 Then
                                  cardAInumFinal(i, 1) = cardAInumFinal(i, 1) + 10
                               End If
                               '=====================
                                  sq = 1
                 ...
                 If Pn4 = 0 Then
                        ...
                        If movecpre = 3 Then
                               If cardAInumcaseperson(i, 1, 11) >= 3 And cardAInumcaseperson(i, 1, 15) >= 3 Then
                                   Select Case uscom
                                        Case 1
                                              For k = 14 * (角色人物對戰人數(2, 2) - 1) + 1 To 14 * 角色人物對戰人數(2, 2)
                                                     If 人物異常狀態資料庫(2, k, 3) = 17 Then
                                                         weryu(1) = 人物異常狀態資料庫(2, k, 2)
                                                     End If
                                               Next
                                        Case 2
                                               For k = 14 * (角色人物對戰人數(1, 2) - 1) + 1 To 14 * 角色人物對戰人數(1, 2)
                                                     If 人物異常狀態資料庫(1, k, 3) = 16 Then
                                                         weryu(1) = 人物異常狀態資料庫(1, k, 2)
                                                     End If
                                               Next
                                   End Select
...
Else
    ...
    livewermax = livecommax(角色人物對戰人數(2, 2))
End If
If 夏洛特_階段處理記錄數(2) = Val(戰鬥系統類.turn) Then
    夏洛特_階段處理記錄數(1) = 0
End If
Select Case turn
    Case 1 '==攻擊階段類
                    ...
                    Erase weryu
                     If cardAInumcaseperson(i, 1, 14) >= 5 Then
                         Select Case uscom
                                Case 1
                                     For k = 2 To 3
                                            For p = 14 * (角色待機人物紀錄數(1, k) - 1) + 1 To 14 * 角色待機人物紀錄數(1, k)
                                               If 人物異常狀態資料庫(1, p, 3) = 35 Then
                                                   werp = 1
                                               End If
                                            Next
                                     Next
                                Case 2
                                     For k = 2 To 3
                                            For p = 14 * (角色待機人物紀錄數(2, k) - 1) + 1 To 14 * 角色待機人物紀錄數(2, k)
                                                If 人物異常狀態資料庫(2, p, 3) = 36 Then
                                                    werp = 1
                                                End If
                                            Next
                                    Next
