...
Case 1
    If adusall <= Me.adust Then
       adus(adusall).Picture = LoadPicture(App.Path & "\gif\atkshow.gif")
       adus(adusall).Visible = True
       adusall = adusall + 1
    End If
    If adcomall <= Me.adcomt Then
       adcom(adcomall).Picture = LoadPicture(App.Path & "\gif\defshow.gif")
       adcom(adcomall).Visible = True
       adcomall = adcomall + 1
    End If
Case 2
   If adusall <= Me.adust Then
       adus(adusall).Picture = LoadPicture(App.Path & "\gif\defshow.gif")
       adus(adusall).Visible = True
       adusall = adusall + 1
    End If
    If adcomall <= Me.adcomt Then
       adcom(adcomall).Picture = LoadPicture(App.Path & "\gif\atkshow.gif")
       adcom(adcomall).Visible = True
       adcomall = adcomall + 1
    End If
End Select
